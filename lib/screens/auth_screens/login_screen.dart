...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // Demo credentials
  final String _adminEmail = 'admin@crispac.com';
  final String _adminPassword = 'admin123';
  final String _customerEmail = 'customer@crispac.com';
  final String _customerPassword = 'customer123';
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(color: Color(0xFF8E2DE2).withOpacity(0.2)),
                  ),
                  child: Column(
                    children: [
                      Text(
                      ...
                      Row(
                        ...
                        children: [
                          _buildDemoChip('Admin', _adminEmail, _adminPassword),
                          _buildDemoChip('Customer', _customerEmail, _customerPassword),
                        ],
                      ),
                    ],
                  ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0xFF8E2DE2).withOpacity(0.3)),
        ),
        child: Column(
          children: [
            Text(
  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (email == _adminEmail && password == _adminPassword) {
        isValid = true;
        isAdmin = true;
      } else if (email == _customerEmail && password == _customerPassword) {
        isValid = true;
        isAdmin = false;
      } else {
        // For testing - accept any email/password that's not empty
      ...
      if (isValid) {
        ...
        await prefs.setString('user_role', isAdmin ? 'Administrator' : 'Customer');
        await prefs.setBool('is_admin', isAdmin);
        await prefs.setString('token', 'demo_token_123');
